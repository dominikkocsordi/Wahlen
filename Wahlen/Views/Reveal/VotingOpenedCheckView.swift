...
struct VotingOpenedCheckView: View {

    // Main event (grünes Stern-Häkchen + Ring)
    ...
    var body: some View {
        ZStack {
            ...
            RadialGradient(
                colors: [
                    greenDeep.opacity(0.14),
                    greenDeep.opacity(0.05),
                    .clear
                ],
                center: .center,
                startRadius: 80,
